  ...
  methods: {
    ...
    setSelectedCategory() {
      if (this.selectedCategory == null) {
        ...
        axios.get("/api/list/" + this.selectedCategory).then(response => {
          this.config = [];
    ...
    setselectedFile() {
      if (this.selectedFile == null) {
        ...
        axios
          .get("/api/config/" + this.selectedCategory + "/" + this.selectedFile)
          .then(response => {
            this.config = [];
    ...
    saveConfig() {
      ...
      axios
        .post(
          "/api/config/" + this.selectedCategory + "/" + this.selectedFile,
          {
